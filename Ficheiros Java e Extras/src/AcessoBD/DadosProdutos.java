...
/**
 * Classe de acesso a base de dados para os produtos
...
public class DadosProdutos {
	 ...
	 * @param produto objecto produto
	 * @return boolean resultado a acao
	 * Adiciona um produto na base de dados através dos dados do Objecto Produto que recebe
	 */
	public static boolean adicionarProduto(Produto produto) {
        ...
        try {
			  ...
			  sqlQuery.append(" INSERT INTO produto  (DESIGNACAO_PRODUTO, FABRICANTE_PRODUTO, QUANTIDADE_PRODUTO, PRECO_PRODUTO, SKU_PRODUTO, LOTE_PRODUTO, DATAPRODUCAO_PRODUTO, ID_CATEGORIA, OBS_PRODUTO) "
			  				+ "	VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?); ");
			...
			DadosConnect.ps.setString(9, produto.getObs());
	 ...
	 * @param categoria objecto categoria
	...
	/**
	 * Devolve o id da categoria com a designacao inserida
	 * @param designacao string de designacao
	 ...
	 * @param sku inteiro sku do produto
	...
	/**
	 * pesquisa categoria na base de dados
	 * @param designacao string com a designacao da categoria
	 ...
	 * @param idCategoria inteiro com id da categoria
	 ...
	 * @param idProduto inteiro com id do produto
	 * @return Objecto Produto
	 * Retorna objecto através da condição de verificar pelo seu ID
	 */
	 ...
	 * @param aCondicao string com a condicao a pesquisar
	 ...
	 * @param aProduto objecto produto
	 * Update de um produto na base de dados através de um objecto produto
